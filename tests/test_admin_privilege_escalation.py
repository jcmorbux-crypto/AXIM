...
class OwnerRoleEscalationTests(unittest.TestCase):
    ...
    'owner' role specifically. Verified live against a real running
    server before this fix existed. See _forbid_owner_grant_by_non_owner
    and docs/AXIM_ROADMAP.md's own writeup of this fix."""
