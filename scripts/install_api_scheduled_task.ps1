...
$action = New-ScheduledTaskAction -Execute $PythonExe `
    -Argument "-m uvicorn api.main:app --host 127.0.0.1 --port 8090" `
...
Register-ScheduledTask -TaskName $TaskName `
    ...
    -Description "Runs AXIM's control UI (127.0.0.1:8090) at logon, restarts on failure (up to 999 times, 1 min apart)." `
    -Force
